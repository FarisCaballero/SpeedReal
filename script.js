const emergencies = [
  ...
  "Poisoning",
  "Drug Overdose",
  "Feeling Weak or Dizzy from Diabetes",
  "Drowning",
  ...
  "Swelling or Breathing Trouble due to Allergic Reaction (Anaphylaxis)",
  "Asthma Attack",
  "Choking",
  "Heavy Bleeding That Won’t Stop (Hemorrhage)",
  "Serious Head Injury",
  "Shaking or Uncontrollable Movements (Seizure)",
  "Shock (Feeling Cold, Faint, or Weak)",
  "Broken Bone (Fracture)",
  "Heart Stopped Beating (Cardiac Arrest)",
  "Tight or Squeezing Chest Pain (Angina)",
  "Severe Pain in Lower Belly (Appendicitis)",
  "Sudden Severe Belly Pain",
  "Serious Back or Spine Injury",
  "Eye Injury",
  "Electric Shock",
  "Seizures During Pregnancy (Eclampsia)",
  "Trouble Breathing from a Collapsed Lung (Pneumothorax)",
  ...
  function getInstructions(emergency) {
    switch (emergency.toLowerCase()) {
      case 'crushing chest pain (heart attack)':
        return `
